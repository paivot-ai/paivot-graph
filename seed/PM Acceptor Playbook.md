...
created: 2026-04-06
confidence: high
vault_name: PM Acceptor Agent
vault_note: This file (seed/PM Acceptor Playbook.md) is seeded into the Obsidian vault as "PM Acceptor Agent" via 'make seed'. Agents load this content at runtime via: vlt vault="Claude" read file="PM Acceptor Agent"
---
