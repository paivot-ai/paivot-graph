...
created: 2026-04-06
confidence: high
vault_name: Anchor Agent
vault_note: This file (seed/Anchor Checklist.md) is seeded into the Obsidian vault as "Anchor Agent" via 'make seed'. Agents load this content at runtime via: vlt vault="Claude" read file="Anchor Agent"
---
